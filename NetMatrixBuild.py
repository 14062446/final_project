...
'''
Authors: Nora Barry and Laura Buchanan
...
def clean_station_data(data):
    '''This function takes in the station data and cleans it, 
    as we are mainly only interested in the total number of bikes 
    ie. totalDocks at each station'''
    ...
    #here we create a guess column, where we make an assumption that when 
    #our Citibike data begins (July 1, 2013) there are approximately 1/2 of 
    #the total available bikes at each station, since it is unreasonable to 
    #assume that each station is full of bikes.    
